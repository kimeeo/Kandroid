...
public abstract class CardStackAdapter implements View.OnTouchListener, View.OnClickListener {
    ...
    public void setAdapterParams(CardStackLayout cardStackLayout) {
        if(cardStackLayout.getHeight()!=0)
            mScreenHeight =cardStackLayout.getHeight();
        ...
        fullCardHeight = (int) (mScreenHeight -(mParentPaddingTop*2)- dp30 - dp8 - (getCount() * mCardGapBottom));
    }
