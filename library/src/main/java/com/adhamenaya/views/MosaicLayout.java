...
public class MosaicLayout extends ScrollView {
	...
	public OnBottomReach getListener() {
		return mListener;
	}

	public void setListener(OnBottomReach mListener) {
		this.mListener = mListener;
	}

	private OnBottomReach mListener;
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt) {
		...
		if (diff == 0 && mListener != null) {
			mListener.onBottomReached(l,t,oldl,oldt);
		}
	...
	public static interface OnBottomReach
	{
		void onBottomReached(int l, int t, int oldl, int oldt);
	}
