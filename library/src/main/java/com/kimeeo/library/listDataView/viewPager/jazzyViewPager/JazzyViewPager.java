package com.kimeeo.library.listDataView.viewPager.jazzyViewPager;
...
public class JazzyViewPager extends ViewPager {
	...
	public static final String TRANSITION_STANDARD="Standard";
	public static final String TRANSITION_TABLET="Tablet";
	public static final String TRANSITION_CUBEIN="CubeIn";
	public static final String TRANSITION_CUBEOUT="CubeOut";
	public static final String TRANSITION_FLIPVERTICAL="FlipVertical";
	public static final String TRANSITION_FLIPHORIZONTAL="FlipHorizontal";
	public static final String TRANSITION_STACK="Stack";
	public static final String TRANSITION_ZOOMIN="ZoomIn";
	public static final String TRANSITION_ZOOMOUT="ZoomOut";
	public static final String TRANSITION_ROTATEUP="RotateUp";
	public static final String TRANSITION_ROTATEDOWN="RotateDown";
	public static final String TRANSITION_ACCORDION="Accordion";
	...
	public JazzyViewPager(Context context, AttributeSet attrs) {
		...
		TRANSITION_CUBEIN,
		TRANSITION_CUBEOUT,
		TRANSITION_FLIPVERTICAL,
		TRANSITION_FLIPHORIZONTAL,
		TRANSITION_STACK,
		TRANSITION_ZOOMIN,
		TRANSITION_ZOOMOUT,
		TRANSITION_ROTATEUP,
		TRANSITION_ROTATEDOWN,
